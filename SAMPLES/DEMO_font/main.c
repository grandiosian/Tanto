...
int main() {
    ...
    char *text = "Le \\c[128000]Château \\c[FFFFFF]est tombé dans le précipice ! \n\\c[FF0000]Nouvelle ligne rouge\nSaut de ligne \\c[00FF00]verte";
    TextAnimation* anim = init_text_animation(text, 10.0f);  // 10 caractères par seconde
    ...
    while(1) {
        ...
        // Afficher du texte
        props.y = 300.0f;
        //draw_text(font, "Le \\c[128000]Château \\c[FFFFFF]est tombé dans le précipice ! \n\\c[FF0000]Nouvelle ligne rouge\nSaut de ligne \\c[00FF00]verte", props);
